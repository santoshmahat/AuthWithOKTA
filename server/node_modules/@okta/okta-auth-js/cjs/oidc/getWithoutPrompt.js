...
function getWithoutPrompt(sdk, options) {
  ...
  if ((0, _util.isLoginRedirect)(sdk)) {
    return Promise.reject(new _errors.AuthSdkError('The app should not attempt to call getToken on callback. ' + 'Authorize flow is already in process. Use parseFromUrl() to receive tokens.'));
  }

  options = (0, _util2.clone)(options) || {};
